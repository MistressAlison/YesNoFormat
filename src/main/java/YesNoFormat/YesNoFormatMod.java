...
import YesNoFormat.util.TextureLoader;
import basemod.*;
...
@SpireInitializer
public class YesNoFormatMod implements
        EditStringsSubscriber,
        PostInitializeSubscriber {
    // Make sure to implement the subscribers *you* are using (read basemod wiki). Editing cards? EditCardsSubscriber.
    // Making relics? EditRelicsSubscriber. etc., etc., for a full list and how to make your own, visit the basemod wiki.
    public static final Logger logger = LogManager.getLogger(YesNoFormatMod.class.getName());
    ...
    public static final String BADGE_IMAGE = "YesNoFormatResources/images/Badge.png";
    ...
    public YesNoFormatMod() {
        logger.info("Subscribe to BaseMod hooks");
        
        BaseMod.subscribe(this);
      
        setModID("YesNoFormat");
        ...
        try {
            SpireConfig config = new SpireConfig("YesNoFormat", "YesNoConfig", yesNoDefaultSettings); // ...right here
    ...
    public static void initialize() {
        ...
        YesNoFormatMod yesNoFormatMod = new YesNoFormatMod();
    ...
    public void receivePostInitialize() {
        ...
        ModLabeledToggleButton enableMaybeButton = new ModLabeledToggleButton(CardCrawlGame.languagePack.getUIString(YesNoFormatMod.makeID("ModConfigMaybe")).TEXT[0],
            ...
            try {
                ...
                SpireConfig config = new SpireConfig("YesNoFormat", "YesNoConfig", yesNoDefaultSettings);
    ...
    public void receiveEditStrings() {
        ...
        BaseMod.loadCustomStringsFile(UIStrings.class,
                getModID() + "Resources/localization/"+loadLocalizationIfAvailable("YesNoFormat-UI-Strings.json"));
